...
export default class Home extends React.Component {
    ...
    /**
     * The below function simple triggers when the delete button is pressed for a delete confirmation 
    ...
    handleButtonToggleDeleteQuestionModal = (toggle,q_id) => {
        ...
        // COMMENTING THIS OUT DOESNT SEEM TO IMPACT ANYTHING ----- DELETE???????
    // renderHomepage() {
    //     this.setState({

                        ...
                        <body id="page-top">
                            ...
                            <nav class="navbar navbar-expand-lg fixed-top" id="mainNav" style={{ backgroundColor: '#DFDFDF', borderTop: '2px solid', borderBottom: '2px solid', color: 'black', paddingTop: '0px', paddingBottom: '0px' }}>
                                <div class="container">
                                    ...
                                    <Form inline onSubmit={this.sessionSEARCH}>
                                        <FormControl type="text" name="search"  spellcheck='true' size="sm" placeholder="Search..." className="mr-sm-1" style={{ borderRadius: '25px', width: '250px' }} />
                                    </Form>
